...
void MyDB::init()
{
    ...
    db.setDatabaseName("/Users/lakshyasharma/Desktop/cppbuzz_grocery_manager1.sqlite");

    if(QFile::exists("/Users/lakshyasharma/Desktop/cppbuzz_grocery_manager1.sqlite"))
